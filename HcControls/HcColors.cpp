...
HcColors::HcColors(QObject *parent) : QObject{parent} {
    ...
    auto yellow = new HcAccentColor(this);
    ...
    auto orange = new HcAccentColor(this);
    ...
    auto red = new HcAccentColor(this);
    ...
    auto magenta = new HcAccentColor(this);
    ...
    auto purple = new HcAccentColor(this);
    ...
    auto blue = new HcAccentColor(this);
    ...
    auto teal = new HcAccentColor(this);
    ...
    auto green = new HcAccentColor(this);
...
[[maybe_unused]] HcAccentColor *HcColors::createAccentColor(const QColor &primaryColor) {
    auto accentColor = new HcAccentColor(this);
    accentColor->normal(primaryColor);
    accentColor->dark(HcTools::getInstance()->withOpacity(primaryColor, 0.9));
    accentColor->light(HcTools::getInstance()->withOpacity(primaryColor, 0.9));
    accentColor->darker(HcTools::getInstance()->withOpacity(accentColor->dark(), 0.8));
    accentColor->lighter(HcTools::getInstance()->withOpacity(accentColor->light(), 0.8));
    accentColor->darkest(HcTools::getInstance()->withOpacity(accentColor->darker(), 0.7));
    accentColor->lightest(HcTools::getInstance()->withOpacity(accentColor->lighter(), 0.7));
    return accentColor;
}
