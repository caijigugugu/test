...
HcRectangle::HcRectangle(QQuickItem *parent) : QQuickPaintedItem(parent) {
    color(QColor(255, 255, 255, 255));
    radius({0, 0, 0, 0});
    connect(this, &HcRectangle::colorChanged, this, [=] { update(); });
    connect(this, &HcRectangle::radiusChanged, this, [=] { update(); });
}

void HcRectangle::paint(QPainter *painter) {
    painter->save();
