...
namespace HcSheetType {
    ...
    QML_NAMED_ELEMENT(HcSheetType)
}

namespace HcThemeType {
    Q_NAMESPACE
    enum DarkMode {
        System = 0x0000,
        Light = 0x0001,
    ...
    QML_NAMED_ELEMENT(HcThemeType)
}

namespace HcTimelineType {
    Q_NAMESPACE
    enum Mode {
        Left = 0x0000,
        Right = 0x0001,
    ...
    QML_NAMED_ELEMENT(HcTimelineType)
}

namespace HcPageType {
    Q_NAMESPACE
    enum LaunchMode {
        Standard = 0x0000,
        SingleTask = 0x0001,
...
namespace HcTabViewType {
    ...
    QML_NAMED_ELEMENT(HcTabViewType)
}

namespace HcNavigationViewType {
    Q_NAMESPACE
    ...
    QML_NAMED_ELEMENT(HcNavigationViewType)
}
