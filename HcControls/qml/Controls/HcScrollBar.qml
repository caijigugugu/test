...
T.ScrollBar {
    ...
    property color color : HcTheme.dark ? Qt.rgba(159/255,159/255,159/255,1) : Qt.rgba(138/255,138/255,138/255,1)
    property color pressedColor: HcTheme.dark ? Qt.darker(color,1.2) : Qt.lighter(color,1.2)
    ...
    background: Rectangle{
        id:back_rect
        radius: 5
        color:HcTheme.dark ? Qt.rgba(44/255,44/255,44/255,1) : Qt.rgba(255/255,255/255,255/255,1)
        opacity:{
            if(vertical){
    ...
    HcIconButton{
        ...
        iconSource: HcIcons.CaretLeftSolid8
        onClicked: {
            control.decrease()
        }
    }
    HcIconButton{
        ...
        visible: control.horizontal
        iconSource: HcIcons.CaretRightSolid8
        onClicked: {
            control.increase()
        }
    }
